...
func (m *defaultRoleModel) Insert(ctx context.Context, data *Role) (sql.Result, error) {
	...
	ret, err := m.conn.ExecCtx(ctx, query, data.Name, data.Code, data.Description, data.Status, data.DeleteAt)
	return ret, err
}
...
func (m *defaultRoleModel) Update(ctx context.Context, newData *Role) error {
	...
	_, err := m.conn.ExecCtx(ctx, query, newData.Id, newData.Name, newData.Code, newData.Description, newData.Status, newData.DeleteAt)
	return err
}
