...
type (
	sysUserRoleModel interface {
		...
		FindOneByUserIdRoleId(ctx context.Context, userId string, roleId int64) (*SysUserRole, error)
...
func (m *defaultSysUserRoleModel) FindOneByUserIdRoleId(ctx context.Context, userId string, roleId int64) (*SysUserRole, error) {
	var resp SysUserRole
